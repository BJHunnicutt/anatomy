function jh_pImport2matlab2(dataDir, saveFlag)
...
%           saveFlag: 0, 1, or 2: 
%                       (0) Don't save 
%                       (1) save the primary outputs from this 
%                       (2) will recreate the rotatedData, originalData and tiffs in each meta3/EID/ folder -- making separate because I don't want to redo these everytime)
% 
% OUTPUTS:  rotatedData: experimental projection matrices aligned to the average template brain and rotated coronally
% 
% DEPENDENCIES: 
%     /auxillary_funcitonsAndScripts/mhd_Reading/Medical_Image_Processing_Toolkit_/Medical_Image_Processing_Toolkit_/class_image/ImageType.m
%     /auxillary_funcitonsAndScripts/mhd_Reading/Medical_Image_Processing_Toolkit_/Medical_Image_Processing_Toolkit_/class_image/VectorImageType.m
%     /auxillary_funcitonsAndScripts/mhd_Reading/read_mhd2.m
...
disp('Where is the avgTemplate100micron.mhd file?')
...
disp('Where is the strmask_25um.mat file?')
...
%     
    ...
    %     save([EID, '/injMeta.mat'], 'injMeta')
        ...
        mkdir([EID, '/tiffs/']) % Creating these tiffs for bundle subtraction and reference
